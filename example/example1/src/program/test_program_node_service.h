#ifndef TEST_PROGRAM_NODE_SERVICE_H
#define TEST_PROGRAM_NODE_SERVICE_H
...
class testProgramNodeService : public ProgramNodeService
{
public:
    testProgramNodeService();
    ~testProgramNodeService();
...
#endif // TEST_PROGRAM_NODE_SERVICE_H
