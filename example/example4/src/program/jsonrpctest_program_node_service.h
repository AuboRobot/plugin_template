#ifndef JSONRPCTEST_PROGRAM_NODE_SERVICE_H
#define JSONRPCTEST_PROGRAM_NODE_SERVICE_H
...
class JsonRpcTestProgramNodeService : public ProgramNodeService
{
public:
    JsonRpcTestProgramNodeService();
    ~JsonRpcTestProgramNodeService();
...
#endif // JSONRPCTEST_PROGRAM_NODE_SERVICE_H
