#ifndef JSONRPCTEST_INSTALLATION_NODE_SERVICE_H
#define JSONRPCTEST_INSTALLATION_NODE_SERVICE_H

#include <aubo_caps/contribution/installation/installation_node_service.h>

using namespace arcs::aubo_scope;

class JsonRpcTestInstallationNodeService : public InstallationNodeService
{
public:
    JsonRpcTestInstallationNodeService(const std::string &location);
...
#endif // JSONRPCTEST_INSTALLATION_NODE_SERVICE_H
