#ifndef TEST2_PROGRAM_NODE_SERVICE_H
#define TEST2_PROGRAM_NODE_SERVICE_H
...
class test2ProgramNodeService : public ProgramNodeService
{
public:
    test2ProgramNodeService();
    ~test2ProgramNodeService();
...
#endif // TEST2_PROGRAM_NODE_SERVICE_H
