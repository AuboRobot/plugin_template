#ifndef TEST2CHILD1_PROGRAM_NODE_SERVICE_H
#define TEST2CHILD1_PROGRAM_NODE_SERVICE_H
...
class test2Child1ProgramNodeService : public ProgramNodeService
{
public:
    test2Child1ProgramNodeService();
    ~test2Child1ProgramNodeService();
...
#endif // TEST2CHILD1_PROGRAM_NODE_SERVICE_H
