#ifndef %{UPPER_NAME}_PROGRAM_NODE_SERVICE_H
#define %{UPPER_NAME}_PROGRAM_NODE_SERVICE_H
...
class %{NodeName}ProgramNodeService : public ProgramNodeService
{
public:
    %{NodeName}ProgramNodeService();
    ~%{NodeName}ProgramNodeService();
...
#endif // %{UPPER_NAME}_PROGRAM_NODE_SERVICE_H
